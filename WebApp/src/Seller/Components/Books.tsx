...
import { Book, AlertPara, AlertType, BookType } from "../../shared.types";
  ...
  function delBook() {
    deleteBook(book.id).then((res) => {
      if (res instanceof Error) {
        ...
        ShowAlert({
          alertMessage: "Successfully Deleted Book " + book.name,
        ...
        <div className="card card-side bg-base-300 shadow-xl my-5">
          ...
          <div className="card-body basis-3/4 flex-row">
            <div className="basis-5/6 flex flex-col">
              <h2 className="card-title text-4xl">{book.name}</h2>
